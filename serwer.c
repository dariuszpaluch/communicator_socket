...
int main(int argc, const char * argv[]) {
    ...
    std::string buf3 = "3;DarekNick;05.01.2016 21:44;Jestem taki fajnt fajny fajny\na to druga linia mojej fajnosci";
    std::string buf4 = "3;TomaszNick;05.01.2016 21:44;Jestem taki fajnt fajny fajny\na to druga linia mojej fajnosci";
    ...
    while(1) {
        ...
        //write(fd2, &buf3[0],buf3.size());
        //write(fd2, &buf4[0],buf4.size());
           // } else {
